...
export default function ProjetPage() {
  ...
  const { title, intro, credit, photos, related } = projet
  const gridPhotos = photos.slice(0, -1)
  const featurePhoto = photos[photos.length - 1]
  const featureIndex = photos.length - 1
      ...
      <main className="pt-16">
        ...
        <section className="py-16 md:py-24 text-center container-wide">
          ...
          <motion.h1
            ...
            style={{ fontSize: 'clamp(38px, 6vw, 80px)', fontWeight: 100, letterSpacing: '0.06em', lineHeight: 1 }}
          ...
          >
            ...
            {credit && (
              <p className="text-[12px] text-[#888] mt-3 tracking-[0.1em] text-center">{credit}</p>
            )}
          </motion.div>
        </section>
        ...
        <section className="container-wide mb-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {gridPhotos.map((photo, i) => (
              <FadeUp key={photo.src} delay={(i % 2) * 0.08}>
                <ZoomablePhoto
                  photo={photo}
                  photoIndex={i}
