...
Turn one piece of content into many. The best social content isn't created from scratch â€” it's extracted from longer-form pillar content and adapted to each platform.
...
Extract "content atoms" â€” self-contained moments from any long-form content that work on their own:
...
1. **Get transcript** â€” use Whisper, Descript, or your podcast host's transcription
2. **Mark timestamps** â€” flag the 5-10 best moments while listening or scanning transcript
3. **Extract clips** â€” pull video/audio clips for each moment (Descript, Opus Clip, or manual)
4. **Write standalone captions** â€” each clip needs context; don't assume the viewer heard the rest
5. **Add subtitles** â€” most social video is watched without sound
6. **Schedule across 1-2 weeks** â€” spread a single episode across multiple posts
...
### Webinar / Live Event â†’ Social Content
...
| Full recording â†’ short clips | Reels, TikTok, Shorts |

### Newsletter â†’ Social Content
...
2. **Extract content atoms** (5-10 per piece â€” quotes, stories, tips, data)
...
1. **Slow hooks** â€” don't build up to the point
2. **No text overlay** â€” many watch without sound
3. **Poor audio** â€” bad audio kills retention instantly
4. **Too long** â€” if it can be shorter, make it shorter
5. **No CTA** â€” tell viewers what to do
6. **Ignoring comments** â€” engagement in first hour matters
