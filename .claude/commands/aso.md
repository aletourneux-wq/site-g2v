...
## Phase 1 â€” Identify Store & Fetch
...
- App name (title) â€” 30 char limit
- Subtitle â€” 30 char limit
- Description (long) â€” not indexed for search, but matters for conversion
- Promotional text â€” 170 chars, updatable without new release
...
- App name (title) â€” 30 char limit
- Short description â€” 80 char limit
- Full description â€” 4,000 char limit, IS indexed for search
- Category + tags
...
## Phase 1.5 â€” Assess Brand Maturity

Before scoring, classify the app into one of three tiers. This determines how
you interpret "textbook ASO" deviations â€” a deliberate brand choice by a
...
**Challenger apps** are scored strictly against textbook ASO best practices â€” every character, screenshot, and keyword matters.
...
## Phase 2 â€” Score Each Dimension
...
- `references/apple-specs.md` â€” Official Apple character limits, screenshot/video specs, CPP/PPO rules, rejection triggers
- `references/google-play-specs.md` â€” Official Google Play limits, screenshot specs, Android Vitals thresholds, policies
- `references/benchmarks.md` â€” Conversion data, rating impact, video lift, screenshot behavior, CPP/event benchmarks
...
## Phase 3 â€” Competitor Comparison (Optional)
...
4. Identify keyword gaps â€” terms competitors rank for that the user's app doesn't target
...
1. **Score card** â€” table with all 6 dimensions, scores, and grade
2. **Top 3 quick wins** â€” changes that take <1 hour and have highest impact
3. **Detailed findings** â€” per-dimension breakdown with specific issues and fixes
4. **Keyword suggestions** â€” based on title/description analysis and competitor gaps
5. **Visual asset recommendations** â€” specific screenshot/video improvements
6. **Priority action plan** â€” ordered list of changes by impact vs effort
...
### Apple App Store â€” Key Facts

- Title (30 chars) + Subtitle (30 chars) + Keyword field (100 **bytes**, hidden) = indexed text
- Keywords field is bytes not chars â€” Arabic/CJK use 2-3 bytes per char
- Long description is NOT indexed for search â€” optimize for conversion only
...
- Screenshots: up to 10 per device. First 3 visible in search â€” 90% never scroll past 3rd
...
- App preview video: up to 3, 15-30s each. Autoplays muted â€” +20-40% conversion lift
- SKStoreReviewController: max 3 prompts per 365 days
- Apple has human editorial curation â€” quality and design matter more
- See `references/apple-specs.md` for full specs, dimensions, and rejection triggers

### Google Play â€” Key Facts

- Title (30 chars) + Short description (80 chars) + Full description (4,000 chars) = indexed text
- Full description IS indexed â€” target 2-3% keyword density naturally
- No hidden keyword field â€” all keywords must be in visible text
- Google NLP/semantic understanding â€” keyword stuffing detected and penalized
...
- Video does NOT autoplay â€” only ~6% of users tap play (low ROI vs iOS)
...
the app's brand maturity tier â€” they may be deliberate choices for Dominant apps.
...
- [ ] Category mismatch â€” app would face less competition in a different category
...
- [ ] No developer responses to negative reviews _(note volume â€” responding at 10M+ reviews is a different challenge than at 1K)_
