...
1. **Competitor URLs** â€” the list of competitor website URLs to profile
2. **Your product** â€” what you do (if not in product marketing context)
3. **Depth level** â€” quick scan (key facts only) or deep profile (full research)
4. **Focus areas** â€” any specific dimensions to prioritize (e.g., pricing, positioning, SEO strength, content strategy)
...
Every claim in a profile should be traceable to a source â€” scraped page content, review data, or SEO metrics. Label inferences clearly.
...
competitor-profiles/
â”œâ”€â”€ raw/
â”‚   â””â”€â”€ <competitor-slug>/
â”‚       â””â”€â”€ <YYYY-MM-DD>/
â”‚           â”œâ”€â”€ scrapes/    # one .md file per scraped page (homepage.md, pricing.md, ...)
â”‚           â”œâ”€â”€ seo/        # one .json file per DataForSEO call (backlinks-summary.json, ranked-keywords.json, ...)
â”‚           â””â”€â”€ reviews/    # one .md or .json file per review source (g2.md, capterra.md, ...)
â”œâ”€â”€ <competitor-slug>.md    # final synthesized profile
â””â”€â”€ _summary.md             # cross-competitor summary
```

Rules:

- `<competitor-slug>` is lowercase, hyphenated (e.g. `responsehub`, `safe-base`)
- `<YYYY-MM-DD>` is the date the data was pulled â€” supports re-running and diffing snapshots over time
...
```
firecrawl_map â†’ competitor URL
```
...
```
firecrawl_scrape â†’ each key page URL
```
...
```markdown
# [Competitor Name] â€” Competitor Profile
...
**Positioning angle**: [how they position â€” e.g., "simplicity-first," "enterprise-grade," "all-in-one"]

**Key messaging themes**:
- [theme 1 â€” with source page]
- [theme 2]
- [theme 3]
...
### Core capabilities
- [capability 1] â€” [brief description from their site]
- [capability 2]
- ...
...
**Notable**: [any pricing quirks â€” per-seat, usage-based, hidden costs]
...
1. [page URL] â€” [keyword] â€” [est. traffic]
2. [page URL] â€” [keyword] â€” [est. traffic]
3. [page URL] â€” [keyword] â€” [est. traffic]
...
### Strengths
- [strength 1 â€” with evidence source]
- [strength 2]
- [strength 3]

### Weaknesses
- [weakness 1 â€” with evidence source]
- [weakness 2]
- [weakness 3]
...
1. **Competitor landscape overview** â€” one paragraph summarizing the competitive field
2. **Comparison table** â€” key metrics side by side for all profiled competitors
3. **Positioning map** â€” where each competitor sits (e.g., simpleâ†”complex, cheapâ†”premium)
4. **Key takeaways** â€” 3-5 strategic observations from the research
5. **Gaps and opportunities** â€” where the market is underserved
...
1. **Parallelize scraping** â€” scrape all competitors' homepages simultaneously, then pricing pages, etc.
2. **Use consistent metrics** â€” pull the same DataForSEO metrics for every competitor so profiles are comparable
3. **Build the summary last** â€” after all individual profiles are complete
4. **Prioritize by relevance** â€” if the user has 10+ competitors, suggest profiling the top 5 first based on domain overlap or market similarity
