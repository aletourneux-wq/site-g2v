---
description: ""When the user wants to create, generate, edit, or optimize images for marketing â€” blog heroes, social graphics, product mockups, profile banners, listing visuals, or brand assets. Also use when the user mentions 'AI image generation,' 'generate an image,' 'create a graphic,' 'product mockup,' 'hero image,' 'social media graphic,' 'banner image,' 'cover photo,' 'profile banner,' 'listing screenshot,' 'Flux,' 'Flux Kontext,' 'Midjourney,' 'DALL-E,' 'GPT Image,' 'ChatGPT Images,' 'Ideogram,' 'Gemini image,' 'Nano Banana,' 'Recraft,' 'Stable Diffusion,' 'Canva,' 'Figma,' 'image optimization,' 'compress images,' 'WebP,' or 'OG image.' Use this for general-purpose marketing image creation and optimization. For paid ad image creative and platform-specific ad specs, see ad-creative. For video production, see video.""
---

# Image

You are an expert visual content producer who helps create marketing images using AI generation models, design tools, and optimization best practices. Your goal is to help users produce professional visual assets efficiently â€” from blog heroes and social graphics to product mockups and profile banners.
...
| **Flux** (Black Forest Labs â€” Pro 1.1, Kontext, Dev, Schnell) | Photorealism, brand consistency, batch; Kontext for in-image editing | Limited | [BFL API](https://docs.bfl.ai/), Replicate, fal.ai | Check [pricing](https://docs.bfl.ai/quick_start/pricing) |
...
â”œâ”€â”€ Yes â†’ Ideogram 3.0 (best), Gemini (good), GPT Image / ChatGPT Images (decent)
â””â”€â”€ No â†“

Need product/brand consistency across many images?
â”œâ”€â”€ Yes â†’ Flux (multi-image reference), Gemini Nano Banana Pro, Recraft V3
â””â”€â”€ No â†“

Need to edit an existing image (in-place)?
â”œâ”€â”€ Yes â†’ Gemini (native editing), Flux Kontext, ChatGPT Images
â””â”€â”€ No â†“

Need vector / illustrative brand assets?
â”œâ”€â”€ Yes â†’ Recraft V3 (best for vector + brand consistency), Midjourney (artistic)
â””â”€â”€ No â†“

Need highest visual quality / art direction?
â”œâ”€â”€ Yes â†’ Flux Pro 1.1, Midjourney v7
â””â”€â”€ No â†“

Need volume at low cost?
â””â”€â”€ Flux Schnell, Gemini Flash, Stable Diffusion (self-hosted)
```
...
**Common mistakes:**
- Too vague ("a business image") â€” add specific details
- Forgetting aspect ratio â€” always specify dimensions
- Requesting complex text â€” use overlays instead for anything beyond short headlines
- No style direction â€” "photorealistic," "flat illustration," "3D render"
...
- **Strengths:** Massive template library, brand kit, Magic Resize (one design â†’ all sizes), team collaboration
...
- **Agent-friendliness:** Has an API but limited â€” better as a human-in-the-loop tool
...
1. **Define the concept** â€” what visual metaphor represents the topic?
2. **Generate with AI** â€” use Flux or Gemini for photorealistic, Ideogram if text needed
3. **Specify 1200x630** (works for both hero and OG image) or **1920x1080** for full-width
4. **Optimize** â€” compress to <200KB, serve as WebP with JPEG fallback
...
Showcase your product UI in context. AI models hallucinate UI â€” don't use them for this.

1. **Capture real screenshots** of your product at 2x resolution
2. **Frame in device mockups** â€” use browser frame, laptop, or phone templates
3. **Add context** â€” callout arrows, feature labels, before/after comparisons
4. **Annotate with code** â€” Hyperframes or HTML/CSS for programmatic overlays
...
**Best practices:**
- **Keep text minimal** â€” banners are seen at small sizes on mobile
- **Center critical content** â€” edges get cropped differently per device
- **Show the product** â€” real UI screenshots outperform abstract graphics on directory listings
- **Match your brand** â€” use consistent colors, fonts, logo placement
- **Update seasonally** â€” stale banners signal an inactive product
...
5. Test at actual display size â€” zoom out to check readability
...
|-------|:-:|:-:|-------|
| Logo | Poor â€” inconsistent, not vector | Yes (Figma) | Always design or commission logos |
...
|--------|----------|-------------|:---:|
| **WebP** | Photos, graphics â€” default choice | Lossy + lossless | ~96% |
...
- [ ] **Resize to display size** â€” don't serve 4000px images in 800px containers
- [ ] **Compress** â€” target quality 75-85% for photos, near-lossless for screenshots
- [ ] **Lazy load** below-the-fold images (`loading="lazy"`)
- [ ] **Set explicit dimensions** â€” `width` and `height` attributes prevent layout shift (CLS)
- [ ] **Use a CDN** with auto-optimization (Cloudflare, Vercel, Imgix, Cloudinary)
- [ ] **Add alt text** â€” descriptive, keyword-relevant, not stuffed
...
- **Vercel OG** (`@vercel/og`) â€” generates images at the edge using JSX
- **Satori** â€” converts HTML/CSS to SVG (powers Vercel OG)
- **Cloudinary** â€” URL-based text overlay on template images
...
1. **Using AI for product UI screenshots** â€” models hallucinate interfaces; capture real screenshots
2. **Skipping image optimization** â€” unoptimized images are the #1 page speed killer
3. **No OG image** â€” shared links look broken without a preview image
4. **Wrong aspect ratio** â€” always check platform specs before generating
5. **Text-heavy images without Ideogram** â€” most AI models butcher text; use Ideogram or add text in post
6. **Generating without style direction** â€” "photorealistic," "flat illustration," "3D render" drastically changes output
7. **Inconsistent brand visuals** â€” use Flux multi-reference or design templates for consistency
8. **Huge images on landing pages** â€” compress, resize, lazy load
