...
3. **Collect specific critiques** â€” not just scores, but what to fix
4. **Revise based on feedback** â€” address the lowest-scoring areas first
5. **Re-score after revisions** â€” iterate until all personas score 7+, with an average of 8+ across the panel
...
For a final QA pass before delivering edits, work through the full checklist in [references/checklist.md](references/checklist.md) â€” covering all seven sweeps plus pre-start and final-check items.
...
Copy editing isn't just for new content. Existing pages decay over time â€” outdated stats, stale examples, and drifted brand voice. Use the content refresh framework when traffic is declining, data is stale, or the product has changed.
